...
// const COLORS = ['#6C5CE7', '#00CECE', '#FF6B6B', '#FDCB6E', '#00B894', '#E17055'];
...
//         {/* Content Input */}
//         <TextInput
//           style={[styles.contentInput, { color: theme.text, borderColor: theme.border, backgroundColor: theme.card }]}
...
// const HEADER_SCROLL_DISTANCE = 110; // 220 - 110
...
//   // ────────── Sticky Title: sticks below collapsed header ──────────
...
//   // Title background opacity (shows bg when sticky)
//   const stickyBgStyle = useAnimatedStyle(() => {
//     const opacity = interpolate(
//       scrollY.value,
//       [0, HEADER_SCROLL_DISTANCE * 0.8, HEADER_SCROLL_DISTANCE],
//       [0, 0, 1],
//       Extrapolation.CLAMP
//     );
//     return { opacity };
...
//         {/* Spacer for sticky title (so content below doesn't overlap) */}
//         <View style={styles.titleStickyPlaceholder} />
...
//       {/* ────────── Sticky Title Input (floats above scroll) ────────── */}
//       <Animated.View
//         entering={FadeInDown.delay(200).springify()}
//         style={[styles.stickyTitleContainer, stickyTitleStyle]}>
//         {/* Background that appears when sticky */}
//         <Animated.View
//           style={[
//             styles.stickyTitleBg,
//             stickyBgStyle,
//             { backgroundColor: theme.background },
//           ]}
//         />
//         <View style={styles.stickyTitleInner}>
...
//   scrollContent: {
//     paddingHorizontal: 20,
//     paddingTop: 230, // Header (220) + gap (10)
//     paddingBottom: 40,
//   },
//   // ────────── Sticky Title Styles ──────────
//   stickyTitleContainer: {
//     position: 'absolute',
//     top: 220, // Starts right below expanded header
//     left: 0,
//     right: 0,
//     zIndex: 99, // Below header (100) but above scroll content
//   },
//   stickyTitleBg: {
...
//     paddingVertical: 12,
//   },
//   titleStickyPlaceholder: {
//     height: 90, // Reserve space for the floating title input
//   },
//   // ────────── Input Styles ──────────
//   label: {
//     fontSize: 16,
    ...
    {/* Document Picker */}
        <Animated.View entering={FadeInDown.delay(350).springify()}>
          ...
          >
            ...
            <Text style={{ color: theme.primary, fontWeight: '600', fontSize: 15 }}>Attach Note</Text>
            {docLoading && <ActivityIndicator size="small" color={theme.primary} style={{ marginLeft: 8 }} />}
          </TouchableOpacity>
        </Animated.View>

        {/* Attached Notes List */}
        {documents.length > 0 && (
          <Animated.View entering={FadeInDown.delay(360).springify()} style={styles.documentList}>
            <Text style={[styles.label, { color: theme.text, marginBottom: 6 }]}>Attached Notes</Text>
            <FlatList
              data={documents}
